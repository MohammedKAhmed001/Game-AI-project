...
BLACK_SOLDIER   = pygame.image.load('images/black_pawn.png')
...
WHITE_SOLDIER   = pygame.image.load('images/white_pawn.png')
...
def print_board(board, color=chess.WHITE):
    ...
    for position in chess.colored_piece_gen(printed_board, chess.SOLDIER, chess.BLACK):
        SCREEN.blit(pygame.transform.scale(BLACK_SOLDIER,   (SQUARE_SIDE,SQUARE_SIDE)), get_square_rect(chess.bb2str(position)))
    ...
    for position in chess.colored_piece_gen(printed_board, chess.SOLDIER, chess.WHITE):
        SCREEN.blit(pygame.transform.scale(WHITE_SOLDIER,   (SQUARE_SIDE,SQUARE_SIDE)), get_square_rect(chess.bb2str(position)))
